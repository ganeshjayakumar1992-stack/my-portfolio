...
const Contact = () => {
  return (
    <>
      <SEOHead 
        description="Get in touch with Ganesh Jayakumar for Salesforce consulting, AI/ML projects, full-stack development, and entrepreneurial collaborations. Available for consulting and startup partnerships."
        keywords={['Salesforce Consulting', 'AI/ML Projects', 'Full Stack Development', 'Entrepreneurial Collaboration', 'Contact']}
        type="website"
      />
      <div 
        className="section"
