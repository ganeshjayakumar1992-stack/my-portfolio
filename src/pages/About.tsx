...
const About = () => {
  return (
    <>
      <SEOHead 
        description="Learn about Ganesh Jayakumar - Salesforce Technical Architect with 15+ years of IT experience. Discover my skills, experience, and passion for AI/ML and environmental technology."
        keywords={['Salesforce Technical Architect', 'AI/ML Developer', 'Full Stack Developer', 'Environmental Technology']}
        type="profile"
      />
      <motion.div 
        className="section" 
